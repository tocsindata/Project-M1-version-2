        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <a href="/" title="Home Page"><img src="/users/images/logo.png" alt="M1 logo"></a><br>
                    <b><?= $awaitingTOTP ? "Two-Factor Authentication" : '' ?></b>
                ...
                <div class="modal-body p-4 <?= $topPad ?>">
                    ...
                    <?php elseif ($settings->no_passwords == 0): ?>
                        <form name="login" id="login-form" class="form-signin" method="post" action="">
                            ...
                            <button class="submit col-12 btn btn-danger rounded submit px-3" id="next_button" type="submit">
