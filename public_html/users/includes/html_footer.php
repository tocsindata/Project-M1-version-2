...
*/
// require_once $abs_us_root . $us_url_root . 'usersc/templates/' . $settings->template . '/footer.php'; // <<< template based footer is here
echo '
<footer  id="footer" class="footer mt-auto" style="background-color: transparent;">
  <div class="container">
    <p class="text-center" style="display:inline-grid ;">&copy; '.date("Y").'<img src="/assets/images/gim-logo.png"></p>
  </div>
</footer>
';
